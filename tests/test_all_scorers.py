...
from scoring.engines.segmentation import SegmentationScoringEngine, rle_decode, rle_encode
...
def test_classification():
    ...
    engine = ClassificationScoringEngine(
        fixtures_dir / "classification_gt.csv",
...
def test_segmentation():
    ...
    engine = SegmentationScoringEngine(
        fixtures_dir / "segmentation_gt.csv",
        metric_type="MIOU"
    )
